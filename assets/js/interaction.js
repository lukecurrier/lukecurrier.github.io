let InteractionJS = {
  ...
  initImgs : function() {
    ...
    if ($("#header-big-imgs").length > 0) {
      InteractionJS.bigImgEl = $("#header-big-imgs");
      InteractionJS.numImgs = InteractionJS.bigImgEl.attr("data-num-img");
  ...
  getImgInfo : function() {
    ...
    const src = InteractionJS.bigImgEl.attr("data-img-src-" + randNum);
    const desc = InteractionJS.bigImgEl.attr("data-img-desc-" + randNum);
